...
You may use the for loop provided below to plot each of the time series in the list. Notice that the pattern has been embedded in the centre of each (i.e. indexes 51 to 57).
```{r, fig.show='hold', eval=FALSE}
...
Keep in mind that these time series were generated randomly, so the embeded pattern will likely not be the only match. If you find that the algorithm is being too permissive, you may try increasing the matching threshold (spearmans.rho.threshold) as you did in part 1.
